...
// void WifiConfigurationSc::StartAccessPoint()
// {
//     // Initialize the TCP/IP stack
//     ESP_ERROR_CHECK(esp_netif_init());
...
// void WifiConfigurationSc::StartWebServer()
// {
...
//         .handler = [](httpd_req_t *req) -> esp_err_t
//         {
//             auto *this_ = static_cast<WifiConfigurationSc *>(req->user_ctx);
...
//                 // 停止Web服务器
//                 auto* self = static_cast<WifiConfigurationSc*>(ctx);
//                 if (self->server_) {
...
//                 // 执行重启
//                 esp_restart(); }, "reboot_task", 4096, this_, 5, NULL);
